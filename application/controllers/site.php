...
//        $data['category']=$this->category_model->getcategorydropdown();
	...
	function createusersubmit()
	{
		...
		$this->form_validation->set_rules('shopcontact2','shopcontact2','trim|required');
		...
		$this->form_validation->set_rules('billingpincode','Billing Pincode','trim|required');
		...
		$this->form_validation->set_rules('shippingpincode','Shipping Pincode','trim|required');
