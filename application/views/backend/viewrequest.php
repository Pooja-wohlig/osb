...
return "<tr><td>" + resultrow.id + "</td><td>" + resultrow.userfrom + "</td><td>" + resultrow.userto + "</td><td>" + resultrow.requeststatus + "</td><td>" + resultrow.amount + "</td><td>" + resultrow.timestamp + "</td><td><a class='btn btn-primary btn-xs' href='<?php echo site_url('site/editrequest?id=');?>"+resultrow.id+"'><i class='icon-pencil'></i></a><a class='btn btn-danger btn-xs' href='<?php echo site_url('site/deleterequest?id='); ?>"+resultrow.id+"'><i class='icon-trash '></i></a></td></tr>";
}
