...
<form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/viewtransaction");?>' enctype= 'multipart/form-data'>
...
<!--<a class="btn btn-default btn-labeled fa fa-plus margined pull-right" href="<?php echo site_url("site/exportexcelreport1"); ?>"target="_blank">Export CSV</a>-->
<a class="btn btn-default btn-labeled fa fa-plus margined pull-right" href="<?php echo site_url("site/exportexcelreport1?sd=".$sd."&ed=".$ed); ?>"target="_blank">Export CSV</a>
