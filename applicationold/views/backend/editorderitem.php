...
//print_r($before['orderitems']);
					...
					<?php 
//print_r($before[orderitems][0]->quantity);
                    ?>
					<div class="form-group">
						<label class="col-sm-2 control-label">Product</label>
						<div class="col-sm-4">
						  <?php 	 echo form_dropdown('product',$product,set_value('product',$before[orderitems][0]->product),'class="chzn-select form-control product  populate placeholder select2-offscreen" id="select3" 	'); ?>
						</div>
					</div>
					<div class="form-group">
